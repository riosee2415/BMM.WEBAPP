        ...
        <WholeWrapper padding={`95px 0 100px`}>
          <RsWrapper>
            ...
            <Wrapper
              ...
              padding={`20px`}
            >
              <Text fontSize={width < 500 ? `16px` : `18px`} fontWeight={`600`}>
                이벤트명이 들어올 곳입니다.
              </Text>
            ...
            <Wrapper width={`840px`} margin={`0 0 60px`}>
              <Text>
                ...
                대통령은 즉시 이를 공포하여야 한다. 국가안전보장회의는 대통령이
                주재한다. 국가는 지역간의 균형있는 발전을 위하여 지역경제를
                육성할 의무를 진다. 국가유공자·상이군경 및 전몰군경의 유가족은
                법률이 정하는 바에 의하여 우선적으로 근로의 기회를 부여받는다.
                공공필요에 의한 재산권의 수용·사용 또는 제한 및 그에 대한 보상은
                법률로써 하되, 정당한 보상을 지급하여야 한다. 모든 국민은 법률이
                정하는 바에 의하여 선거권을 가진다. 위원은 정당에 가입하거나
                정치에 관여할 수 없다. 형사피의자 또는 형사피고인으로서
                구금되었던 자가 법률이 정하는 불기소처분을 받거나 무죄판결을
                받은 때에는 법률이 정하는 바에 의하여 국가에 정당한 보상을
                청구할 수 있다.
              </Text>
            </Wrapper>
            <Wrapper>
