          ...
          <RsWrapper>
            ...
            <Wrapper>
              ...
              <Wrapper al={`flex-start`}>
                이 약관은 주식회사 BMM(전자상거래 사업자로 이하 "회사"라 한다)이
                운영하는 BUYMEMINE 쇼핑몰(이하 "몰"이라 한다)에서 제공하는
              ...
              <Wrapper al={`flex-start`}>
                ① "몰" 이란 "회사"가 재화 또는 용역(이하 "재화 등" 이라 함)을
              ...
              <Wrapper al={`flex-start`}>
                ...
                신고번호(해외사업자의 경우 제외), 개인정보관리책임자 등을
                이용자가 쉽게 알 수 있도록 사이버몰의 초기 서비스화면(전면)에
                게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수
                있도록 할 수 있습니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ② "몰"은 이용자가 약관에 동의하기에 앞서 약관에 정해진 내용 중
                청약철회·배송책임·환불조건 등과 같은 중요한 내용을 이용자가
              ...
              <Wrapper al={`flex-start`}>
                ③ "몰"이 회원 자격을 제한·정지 시킨 후, 동일한 행위가 2회이상
              ...
              <Wrapper al={`flex-start`}>
                ② "몰"이 제3자에게 구매자 개인정보를 제공·위탁할 필요가 있는
                경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시
                미리 포괄적으로 동의를 받지 않습니다. 이 때 "몰"은 제공되는
                개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및
                보유ㆍ이용 기간 등을 구매자에게 명시하여야 합니다. 다만
              ...
              <Wrapper al={`flex-start`}>
                ...
                호의 방법 중 가용한 방법으로 할 수 있습니다. 단, "몰"은 이용자의
              ...
              <Wrapper al={`flex-start`}>
                ...
                합니다. 다만 "몰"이 고의ㆍ과실이 없음을 입증한 경우에는 그러하지
                아니합니다.
              </Wrapper>
              <Wrapper
                al={`flex-start`}
              ...
              <Wrapper al={`flex-start`}>
                ...
                할 수 있습니다. 다만, 청약철회에 관하여 「전자상거래 등에서의
              ...
              <Wrapper al={`flex-start`}>
                　• 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본인
                재화 등의 포장을 훼손한 경우
              </Wrapper>
              <Wrapper al={`flex-start`}>
              ...
              <Wrapper al={`flex-start`}>
                ...
                재화 등을 공급받은 날부터 3월이내, 그 사실을 안 날 또는 알 수
                있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑤ 이용자가 구매요청한 제품을 “몰”이 이미 구매를 진행한 상태라면,
                이용자는 구매요청한 제품의 취소가 불가능합니다.
              </Wrapper>
              <Wrapper
                al={`flex-start`}
                margin={`30px 0 10px`}
              ...
              <Wrapper al={`flex-start`}>
                ① "몰"은 이용자로부터 재화 등을 반환 받은 경우 3영업일 이내에
                이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이
                이용자에게 재화 등의 환급을 지연한때에는 그 지연기간에 대하여
              ...
              <Wrapper al={`flex-start`}>
                ...
                지체없이 당해 결제수단을 제공한 사업자로 하여금 재화 등의 대금의
              ...
              <Wrapper al={`flex-start`}>
                ...
                표시ㆍ광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회
              ...
              <Wrapper al={`flex-start`}>
                ...
                관한 이용자의 동의거절　시 제한되는 서비스를 구체적으로
                명시하고, 필수수집항목이 아닌 개인정보의 수집·이용·제공에 관한
                이용자의 동의 거절을 이유로 회원가입 등 서비스 제공을 제한하거나
                거절하지 않습니다.
              </Wrapper>
              <Wrapper
                al={`flex-start`}
              ...
              <Wrapper al={`flex-start`}>
                ③ "몰"이 상품이나 용역에 대하여 「표시ㆍ광고의 공정화에 관한
                법률」 제3조 소정의 부당한 표시ㆍ광고행위를 함으로써 이용자가
              ...
              <Wrapper al={`flex-start`}>② 타인의 정보 도용</Wrapper>
              <Wrapper al={`flex-start`}>③ "몰"에 게시된 정보의 변경</Wrapper>
              <Wrapper al={`flex-start`}>
              ...
              <Wrapper al={`flex-start`}>
                ① "몰"은 천재지변, 전쟁 및 기타 불가항력, 회사의 합리적인 통제
                범위를 벗어난 사유로 인하여 서비스를 제공할 수 없는 경우에는
                그에 대한 책임이 면제됩니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
              ...
              <Wrapper al={`flex-start`}>
                ③ "몰"은 회원이 서비스를 통해 게재 또는 전송한 정보, 자료,
                사실의 정확성, 신뢰성 등 내용에 관하여 어떠한 보증도 하지
                아니하며 회원의 서비스 자료에 대한 취사선택 또는 이용으로
                발생하는 손해 등에 대해 책임을 지지 아니합니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ④ "몰"은 회원이 서비스를 이용하여 기대하는 손익이나 서비스를
                통하여 얻은 자료로 인한 손해에 관하여 책임을 지지 아니합니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑤ "몰"은 회원 상호간 또는 회원과 제 3자 상호간에 서비스를 매개로
                발생한 분쟁에 대해서는 개입할 의무가 없으며 이로 인한 손해를
                배상할 책임도 없습니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑥ "몰"은 회원의 귀책사유로 인하여 서비스 이용의 장애가 발생한
                경우에는 책임이 면제됩니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑦ 본 약관의 규정을 위반함으로 인하여 회사에 손해가 발생하게 되는
                경우, 이 약관을 위반한 회원은 회사에 발생되는 모든 손해를
                배상하여야 하며, 동 손해로부터 회사를 면책 시켜야 합니다
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑧ "몰"은 서비스에서 제공되는 전자우편의 메시지, 게시판의 게시물
                등이 보유되는 최대일수, 송수신 할 수 있는 전자우편 메시지의
                최대크기, 회원에게 할당되는 최대 디스크 공간 등 일반 사용에 대한
                제한을 할 수 있습니다. 또한 일정 기간 동안 활동이 없는 계정을
                해지할 수 있습니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑨ 어떠한 경우를 불문하고 회사는 배송지연으로 인한 손해에 대해서
                책임지지 않습니다.
              </Wrapper>
              <Wrapper al={`flex-start`}>
                ⑩ "몰"에서 배송 및 구매대행 신청서 작성시 주의사항 안내에 따르지
                않은 회원에 손실에 대해서는 책임지지 않습니다.
              </Wrapper>
              <Wrapper
                al={`flex-start`}
                margin={`30px 0 10px`}
