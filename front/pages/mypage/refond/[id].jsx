                    ...
                    >
                      ...
                      >
                        <Image
                          ...
                          height={`64px`}
                        />
                        <Text padding={`0 45px 0 14px`}>오레오 시리즈</Text>
            ...
            <Wrapper width={`100%`}>
              ...
              >
                ...
                <Wrapper
                  ...
                  padding={`0 10px`}
                >
                  <Text color={Theme.grey_C}>mine@gmail.com</Text>
                </Wrapper>
              </Wrapper>
              <Wrapper
                dr={`row`}
              ...
              >
                ...
                <Wrapper
                  ...
                  padding={`0 10px`}
                >
                  <Text color={Theme.grey_C}>01000000000</Text>
                </Wrapper>
              </Wrapper>
              <Wrapper
                dr={`row`}
              ...
              >
                ...
                >
                  <Wrapper
                    ...
                    position={`relative`}
                    width={width < 1100 ? `160px` : `111px`}
                  >
                    <Image
                      height={width < 1100 ? `160px` : `111px`}
                      alt="리뷰 사진"
                      src={`https://4leaf-s3.s3.ap-northeast-2.amazonaws.com/bmm/assets/images/sample-img/review.png`}
                    />
                    <Circle>
