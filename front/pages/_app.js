...
const Fourleaf = ({ Component }) => {
  ...
  return (
    <ThemeProvider theme={Theme}>
      <GlobalStyles />
      <Head>
        <title>BUY ME MINE | administrator</title>
        ...
        <meta name="keywords" content="BUY ME MINE" />
        <meta property="og:keywords" content="BUY ME MINE" />

        <meta property="og:description" content="BUY ME MINE" />
        <meta name="description" content="BUY ME MINE" />
